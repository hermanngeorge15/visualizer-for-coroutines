...
class SessionRoutesTest {
    ...
    @Test
    fun `POST sessions creates a session with name`() =
        testApplication {
            application { module() }
            val client = jsonClient()
    ...
    @Test
    fun `POST sessions creates a session without name`() =
        testApplication {
            application { module() }
            val client = jsonClient()
    ...
    @Test
    fun `GET session by id returns the created session`() =
        testApplication {
            application { module() }
            val client = jsonClient()
    ...
    @Test
    fun `GET sessions returns the created session in the list`() =
        testApplication {
            application { module() }
            val client = jsonClient()
    ...
    @Test
    fun `DELETE session removes the session`() =
        testApplication {
            application { module() }
            val client = jsonClient()
    ...
    @Test
    fun `GET session returns 404 after deletion`() =
        testApplication {
            application { module() }
            val client = jsonClient()
    ...
    @Test
    fun `DELETE non-existent session returns 404`() =
        testApplication {
            application { module() }
            val client = jsonClient()
    ...
    @Test
    fun `full session CRUD lifecycle`() =
        testApplication {
            application { module() }
            val client = jsonClient()
    ...
    @Test
    fun `GET session events returns empty list for new session`() =
        testApplication {
            application { module() }
            val client = jsonClient()
    ...
    @Test
    fun `GET session events returns 404 for non-existent session`() =
        testApplication {
            application { module() }
            val client = jsonClient()
    ...
    @Test
    fun `GET session hierarchy returns 404 for non-existent session`() =
        testApplication {
            application { module() }
            val client = jsonClient()
    ...
    @Test
    fun `GET session threads returns 404 for non-existent session`() =
        testApplication {
            application { module() }
            val client = jsonClient()
