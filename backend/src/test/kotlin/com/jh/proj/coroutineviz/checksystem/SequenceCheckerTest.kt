...
class SequenceCheckerTest {
    ...
    private fun created(seq: Long): CoroutineCreated = CoroutineCreated(
    ...
    private fun started(seq: Long): CoroutineStarted = CoroutineStarted(
        sessionId = "test-session",
        seq = seq,
        tsNanos = seq * 1000,
        coroutineId = "c1",
    ...
    private fun completed(seq: Long): CoroutineCompleted = CoroutineCompleted(
        sessionId = "test-session",
        seq = seq,
        tsNanos = seq * 1000,
        coroutineId = "c1",
    ...
    fun `correct order passes`() {
        ...
        val result = SequenceChecker.checkOrdering(
            events,
