...
class ScenarioRoutesTest {
    ...
    @Test
    fun `GET scenarios returns list of available scenarios`() =
        testApplication {
            application { module() }
    ...
    @Test
    fun `GET scenarios includes nested scenario`() =
        testApplication {
            application { module() }
            val client = jsonClient()
    ...
    @Test
    fun `GET scenarios includes realistic scenarios`() =
        testApplication {
            application { module() }
            val client = jsonClient()
    ...
    @Test
    fun `POST scenarios nested with existing session ID uses that session`() =
        testApplication {
            application { module() }
            val client = jsonClient()
    ...
    @Test
    fun `POST scenarios parallel returns response`() =
        testApplication {
            application { module() }
            val client = jsonClient()
    ...
    @Test
    fun `session events endpoint returns events when session has data`() =
        testApplication {
            application { module() }
            val client = jsonClient()
    ...
    @Test
    fun `scenario execution creates coroutines visible in session snapshot`() =
        testApplication {
            application { module() }
            val client = jsonClient()
