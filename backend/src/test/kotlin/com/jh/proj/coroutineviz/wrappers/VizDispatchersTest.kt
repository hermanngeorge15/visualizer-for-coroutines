...
class VizDispatchersTest {
    ...
    fun testDefaultDispatcherEmitsEvents() =
        runTest {
    ...
    fun testIODispatcherEmitsEvents() =
        runTest {
    ...
    fun testThreadAssignedEventsIncludeDispatcherName() =
        runTest {
    ...
    fun testDispatcherSwitchingInNestedCoroutines() =
        runTest {
    ...
    fun testCustomDispatcherInstrumentation() =
        runTest {
    ...
    fun testVizDispatchersWithVizAsync() =
        runTest {
            ...
            val deferred =
                scope.vizAsync(label = "async-task") {
                    vizDelay(100)
                    "result"
                }
    ...
    fun testMultipleCoroutinesOnSameDispatcher() =
        runTest {
